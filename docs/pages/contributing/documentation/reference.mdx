...
You can add a second dimension of categories to a `Tabs` component by adding the
`dropdownCaption` and `dropdownSelected` options, as shown below:
...
```jsx
<Tabs dropdownView dropdownCaption="Teleport Component" dropdownSelected="Auth Service">
  <TabItem label="Database Service" selected>
...
<Tabs dropdownView dropdownCaption="Teleport Component" dropdownSelected="Auth Service">
  <TabItem label="Database Service" options="Database Service">
  More information about the Database Service.
  </TabItem>
  <TabItem label="Application Service" options="Application Service">
  More information about the Application Service.
  </TabItem>
  <TabItem label="Desktop Service" options="Desktop Service">
  More information about the Desktop Service.
  </TabItem>
  <TabItem label="SSH Service" options="SSH Service">
  More information about the SSH Service.
  </TabItem>
  <TabItem label="Kubernetes Service" options="Kubernetes Service">
  More information about the Kubernetes Service.
  </TabItem>
  <TabItem label="Machine ID" options="Machine ID">
  More information about the Machine ID.
  </TabItem>
  <TabItem label="Auth Service" options="Auth Service">
  More information about the Auth Service.
  </TabItem>
  <TabItem label="Proxy Service" options="Proxy Service">
  More information about the Proxy Service.
  </TabItem>
</Tabs>
